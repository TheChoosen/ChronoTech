-- Données de test Customer 360 - Structures existantes

-- Données pour customer_activities (nouvelle)
...
-- Données pour customer_consents (structure existante)
...
(1, 'data_processing', 'Traitement des données dans le cadre de la relation contractuelle', 'contract', 1, '2025-01-10 10:00:00', 'website'),
(1, 'marketing_email', 'Envoi d''informations commerciales par email', 'consent', 1, '2025-01-10 10:00:00', 'website'),
(1, 'marketing_sms', 'Envoi d''informations commerciales par SMS', 'consent', 0, NULL, 'website'),
(2, 'data_processing', 'Traitement des données dans le cadre de la relation contractuelle', 'contract', 1, '2025-01-12 14:30:00', 'website'),
(2, 'marketing_email', 'Envoi d''informations commerciales par email', 'consent', 1, '2025-01-12 14:30:00', 'website'),
(3, 'data_processing', 'Traitement des données dans le cadre de la relation contractuelle', 'contract', 1, '2025-01-15 09:15:00', 'website');

-- Données pour customer_communications (structure existante)
...
-- Données pour customer_preferences (nouvelle)
...
-- Données pour customer_analytics (structure existante RFM)
...
-- Données pour customer_rfm_scores (nouvelle)
